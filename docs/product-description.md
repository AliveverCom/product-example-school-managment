...
说明：学生与班级保持“多对一”业务关系，但当前文档不在学生属性中新增“班级ID”字段，班级归属通过“班级-学生对照表”维护，仅保留当前最新有效关系。
...
| 关联对象 | 关系 | 关系说明 |
|---|---|---|
| 班级 | 多对一 | 一个学生只对应一个当前班级，一个班级可以包含多个学生；当前系统仅保留学生与班级的最新有效关系 |
...
| 班级 | 一对多 / 多对多组合关系 | 老师既可通过班级中的“班主任ID”担任班主任，也可通过“班级-课程-老师对照表”参与具体班级教学安排 |
...
| 老师 | 一对多 / 多对多组合关系 | 班级通过“班主任ID”关联班主任，并通过“班级-课程-老师对照表”管理具体授课安排 |
...
当前系统通过该对照表维护学生当前最新的班级归属关系，并通过进班日期、离班日期识别当前有效记录；完整转班历史暂不作为当前需求范围。
